...
- What's left: (1) QUOTA — RAGAS-judge day (~30 calls, fresh day; decides reverse_rel + s.39 + s.34) + AI-expander/3-legal live smoke; (2) OWNER — demo video, NVDA/keyboard/mic gates, LinkedIn, optional Streamlit Cloud 2nd link; (3) CODE (post-judge) — fix-B decision on TOC-trap cites (constrain cites to retrieved refs?) vs documented PARTIALs. Nothing else blocked.
